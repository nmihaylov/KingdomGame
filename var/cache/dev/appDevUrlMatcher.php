...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/b')) {
            // battle_report
            if (0 === strpos($pathinfo, '/battle') && preg_match('#^/battle/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'battle_report')), array (  '_controller' => 'KingdomGameBundle\\Controller\\BattleController::battleReport',));
            }
        ...
        // arm_unit
        if ($pathinfo === '/armUnit') {
            return array (  '_controller' => 'KingdomGameBundle\\Controller\\UnitsController::armUnits',  '_route' => 'arm_unit',);
        }
