 ...
 */
class Building extends \KingdomGameBundle\Entity\Building implements \Doctrine\ORM\Proxy\Proxy
{
    /**
     ...
     * {@inheritDoc}
     */
    public function setTimeCosts(\KingdomGameBundle\Entity\BuildingCostTime $timeCosts)
    {
    ...
    public function getKingdomBuildings()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getKingdomBuildings', []);

        return parent::getKingdomBuildings();
    }
