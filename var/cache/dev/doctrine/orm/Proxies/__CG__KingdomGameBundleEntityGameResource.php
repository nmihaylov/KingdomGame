 ...
 */
class GameResource extends \KingdomGameBundle\Entity\GameResource implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (GameResource $proxy) {
    ...
    public function getKingdomResources()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getKingdomResources', []);

        return parent::getKingdomResources();
    }
