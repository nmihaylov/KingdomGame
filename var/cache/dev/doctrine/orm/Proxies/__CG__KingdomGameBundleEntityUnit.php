 ...
 */
class Unit extends \KingdomGameBundle\Entity\Unit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'id', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'costs', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'timeCost', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'kingdomUnits', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'battleUnits', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'unitDependencies', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'unitCoefficient', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'name'];
        }
    ...
    public function getKingdomUnits()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getKingdomUnits', []);

        return parent::getKingdomUnits();
    }
    ...
    public function getUnitDependencies()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnitDependencies', []);

        return parent::getUnitDependencies();
    }
    ...
    public function setUnitDependencies(array $unitDependencies)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUnitDependencies', [$unitDependencies]);

        return parent::setUnitDependencies($unitDependencies);
    }
    ...
    public function getUnitCoefficient()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnitCoefficient', []);

        return parent::getUnitCoefficient();
    }

    /**
     * {@inheritDoc}
     */
    public function setUnitCoefficient(\KingdomGameBundle\Entity\UnitCoefficient $unitCoefficient)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUnitCoefficient', [$unitCoefficient]);

        return parent::setUnitCoefficient($unitCoefficient);
    }
