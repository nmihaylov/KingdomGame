...
class Unit extends \KingdomGameBundle\Entity\Unit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'id', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'costs', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'timeCost', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'kingdomUnits', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'battleUnits', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'unitDependencies', '' . "\0" . 'KingdomGameBundle\\Entity\\Unit' . "\0" . 'name'];
        }
